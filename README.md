...
To POST a new object to your existing array for ProductType, select POST, then input `localhost:5000/productTypes` into the field. Then click Body, select Raw, paste in the snippet below, and click Send. The result should be the new ProductType you made:
...
To update an existing ProductType, select PUT, then input `localhost:5000/productTypes/2` or the Id of another existing ProductType. Then click Body, select Raw, paste in the snippet below, and click Send.
...
To DELETE an existing ProductType, select DELETE, then input `localhost:5000/productTypes/4` or the Id of another existing ProductType and click Send. You should get a "200 OK" status. If you run a GET query using the Id you specified in your DELETE query, that item should no longer exist.
...
To GET all Employees, select GET in Postman, then input `localhost:5000/employees` into the field and click Send. The result should be an array of all Employees in the database that should look like this:
...
To GET a specific Employee, add an Id to the end of the `localhost:5000/employees` URL, e.g. `localhost:5000/employees/1`. Only the single Employee with the Id you added should display once you click Send, like below:
...
To POST a new object to your existing array for Employees, select POST, then input `localhost:5000/Employees` into the field. Then click Body, select Raw, paste in the snippet below, and click Send. The result should be the new ProductType you made:
...
To update an existing Employee, select PUT, then input `localhost:5000/employees/2` or the Id of another existing Employee. Then click Body, select Raw, paste in the snippet below, and click Send.
...
To DELETE an existing Employee, select DELETE, then input `localhost:5000/employees/4` or the Id of another existing Employee and click Send. You should get a "200 OK" status. If you run a GET query using the Id you specified in your DELETE query, that item should no longer exist.

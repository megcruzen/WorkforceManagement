...
CREATE TABLE EmployeeTraining (
    ...
    CONSTRAINT FK_EmployeeTraining_Employee FOREIGN KEY(EmployeeId) REFERENCES Employee(Id) ON DELETE CASCADE,
    CONSTRAINT FK_EmployeeTraining_Training FOREIGN KEY(TrainingProgramId) REFERENCES TrainingProgram(Id) ON DELETE CASCADE
);
...
CREATE TABLE Product (
    ...
    CONSTRAINT FK_Product_Customer FOREIGN KEY(CustomerId) REFERENCES Customer(Id) ON DELETE CASCADE
);
